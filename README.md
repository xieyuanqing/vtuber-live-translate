...
- **AI 内容整理**：可在业务页整理现场背景，或根据 YouTube、哔哩哔哩、Twitch 视频/直播链接生成本场上下文；支持 Gemini 原生与 OpenAI 兼容接口。
...
- **场景库**是唯一的长期配置：保存可复用的场景名称与场景提示词，同传和视频分别维护使用中的场景与默认项。
...
3. 在同传或视频主页选择源语言、目标语言和场景，必要时进场景库编辑场景提示词。
